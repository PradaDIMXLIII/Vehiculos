...
public class UsandoLibreria {
	...
	public static void main(String[] args) {
		...
		Collection<Comerciable> productos = Arrays.asList(productoExterno, cocheProducto, new Comerciable() {
...
//		System.out.println(getValorTotal(coches));
		...
		System.out.println("\nUsando Merchantable");
		Collection<Merchantable> merchantables = Arrays.asList(productoExterno, cocheProducto);
